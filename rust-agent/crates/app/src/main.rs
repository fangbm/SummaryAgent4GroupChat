...
async fn run_background_image_pipeline_inner(
    ...
    let image_summary_result = summary_image::run_llm_stage(
        config,
        image_pipeline_slots,
        room_id,
        ImagePipelineStage::Summary,
    ...
    let image_prompt = summary_image::run_llm_stage(
        config,
        image_pipeline_slots,
        room_id,
        ImagePipelineStage::Prompt,
...
fn spawn_voice_transcription_task(
    ...
    audio_prep: Arc<media_audio::VoiceTranscriptionAudioPrep>,
    candidate: &(usize, usize, String),
    item_total: usize,
    room_id: &str,
) {
    ...
    join_set.spawn(async move {
        ...
        let result = match media_audio::prepare_voice_transcription_audio(audio_prep, source).await {
